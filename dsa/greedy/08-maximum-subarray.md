...
## Problem
Given an integer array `nums`, find the contiguous non-empty subarray with the largest sum and return its sum. Constraints: `1 <= len(nums) <= 10^5`, `-10^4 <= nums[i] <= 10^4`.
